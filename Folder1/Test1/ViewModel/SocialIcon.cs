...
namespace Test1.ViewModel
{
    public class SocialIcon
    {
        ...
        {  
            ...
            icons.Add(new SocialIcon { ID = 2, IconName = "Facebook", IconBgColor = "#3B5998", IconTargetUrl="https://www.facebook.com/cuonggphan01", IconClass="fa fa-facebook" });  
            ...
            icons.Add(new SocialIcon { ID = 5, IconName = "GitHub", IconBgColor = "#55acee", IconTargetUrl = "https://github.com/PVCuong2001",IconClass="fa fa-github" });  
